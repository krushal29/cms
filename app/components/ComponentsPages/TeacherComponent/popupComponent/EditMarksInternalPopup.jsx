...
const EditMarksInternalPopup = ({ onCloseEvent,form,onChangeEdit,onSubmitEditHandle }) => {
  return (
      ...
      <div className='bg-card  px-10 pt-7 rounded-[10px] w-[34%] relative'>
        ...
        <form action="#">
          <div className='pt-6'>
            ...
            <Input className='mt-3 bg-primary-foreground border border-black shadow-2xl outline-none focus:outline-none focus:ring-0 focus:border-black focus-visible:ring-0 hover:border-black data-[state=open]:border-black' placeholder='Enter mid-sem marks' type='text' onChange={onChangeEdit} name='MidSemMarks' value={form.MidSemMarks} required />
          </div>
          <div className='pt-4'>
            <Label htmlFor="" className='font-semibold text-[17px]'>Quiz Marks <span className='text-[#DE0D0D]'>*</span></Label>
            <Input className='mt-3 bg-primary-foreground border border-black shadow-2xl outline-none focus:outline-none focus:ring-0 focus:border-black focus-visible:ring-0 hover:border-black data-[state=open]:border-black' placeholder='Enter Quiz Marks' value={form.QuizMarks} name='QuizMarks' onChange={onChangeEdit} type='text' required />
          </div>

          <div className='pt-4'>
            <Label htmlFor="" className='font-semibold text-[17px]'>Project Marks <span className='text-[#DE0D0D]'>*</span></Label>
            <Input className='mt-3 bg-primary-foreground border border-black shadow-2xl outline-none focus:outline-none focus:ring-0 focus:border-black focus-visible:ring-0 hover:border-black data-[state=open]:border-black' placeholder='Enter Project Marks' value={form.ProjectMarks} name='ProjectMarks' onChange={onChangeEdit} type='text' required />
          </div>


          <div className='pt-4'>
            <Label htmlFor="" className='font-semibold text-[17px]'>Presentation Marks <span className='text-[#DE0D0D]'>*</span></Label>
            <Input className='mt-3 bg-primary-foreground border border-black shadow-2xl outline-none focus:outline-none focus:ring-0 focus:border-black focus-visible:ring-0 hover:border-black data-[state=open]:border-black' placeholder='Enter presentation marks' value={form.SeminarMarks} name='SeminarMarks' onChange={onChangeEdit} type='text' required />
          </div>


          <div className='pt-4'>
            <Label htmlFor="" className='font-semibold text-[17px]'>Attendance Marks <span className='text-[#DE0D0D]'>*</span></Label>
            <Input className='mt-3 bg-primary-foreground border border-black shadow-2xl outline-none focus:outline-none focus:ring-0 focus:border-black focus-visible:ring-0 hover:border-black data-[state=open]:border-black' placeholder='Enter Attendance Marks' value={form.AttendenceMarks} name='AttendenceMarks' onChange={onChangeEdit} type='text' required />
          </div>

          <div className='py-8'>
            <Button className='w-1/2 cursor-pointer' onClick={onSubmitEditHandle}>Submit</Button>
          </div>
        </form>
      </div>
