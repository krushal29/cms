...
const ExamInternalMarksSubmitSaveComponent = () => {
    const [Marks, setMarks] = useState({});
    const [selectSem,setSelelctSem]=useState("");
    ...
    return (
        <div className="bg-background min-h-[50.8vh] flex justify-center py-10">
            <div className="w-[80%]">
                ...
                <div className="grid grid-cols-2 gap-y-5 bg-secondary py-12 px-8 mb-10 rounded-2xl drop-shadow-lg shadow-ring">
                    {enrollmentNumbers.map((val, index) => (
                        <div key={index} className="flex items-center">
                            ...
                            <div className="w-[28%] pl-5">
                                <Input className="bg-white border border-black shadow-2xl outline-none focus:outline-none focus:ring-0 focus:border-black focus-visible:ring-0 hover:border-black data-[state=open]:border-black rounded-2xl h-8" name="Marks" value="19/20" onChange={(e) => MarksHandle(e, val)} type="text" />
                            </div>
                            {/* <div className="pl-2">
                    ...
                    <div className="pt-5">
                        <Button className="cursor-pointer text-[17px] py-5 px-10">Save Changes</Button>
                    </div>
...
export default ExamInternalMarksSubmitSaveComponent