...
const InternalMarksViva = ({OnCloseViewDetails}) => {
  return (
          <div className="flex justify-center items-center h-screen ">
              <div className="border-1 border-black rounded-2xl py-5 px-10 bg-card drop-shadow-lg shadow-ring">
...
export default InternalMarksViva