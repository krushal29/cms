  ...
  return (
    <div className="bg-secondary flex justify-center pt-8 py-8">
      <div className="w-[70%] text-center">
        <h1  className="text-[28px] font-bold underline text-center underline-offset-4">Achivements</h1>
        ...
        <div className="grid grid-cols-3 gap-10 py-10">
          {AchivementsData.map((data,index)=>(
            <div key={index} className="bg-background drop-shadow-lg shadow-ring rounded-2xl">
