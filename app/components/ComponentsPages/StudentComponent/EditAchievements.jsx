...
const EditAchievements = ({ onEditCloseAchievement, editData, onChangeEditHandle, onEditHandle }) => {
            ...
            <div className='bg-card  px-10 pt-7 rounded-[10px] w-[34%] relative h-[90%] overflow-y-scroll'>
                ...
                <form action="#">
                    <div className='pt-6'>
                        ...
                        <Input className='mt-3 bg-primary-foreground' placeholder='Enter achievement title' type='text' value={editData.AchievementTitle} name='AchievementTitle' onChange={onChangeEditHandle} />
                    </div>
                    <div className='pt-4'>
                        <Label htmlFor="" className='font-semibold text-[17px]'>Achievement Type</Label>
                        <Input className='mt-3 bg-primary-foreground' placeholder='Enter achievement type (e.g., Academic)' type='text' value={editData.AchievementType} name='AchievementType' onChange={onChangeEditHandle} />
                    </div>
                    <div className='pt-4'>
                        <Label htmlFor="" className='font-semibold text-[17px]'>Location</Label>
                        <Input className='mt-3 bg-primary-foreground' placeholder='Enter Location' type='text' value={editData.Location} name='Location' onChange={onChangeEditHandle} />
                    </div>
                    <div className='pt-4'>
                        <Label htmlFor="" className='font-semibold text-[17px]'>Organised By</Label>
                        <Input className='mt-3 bg-primary-foreground' placeholder='Enter organizer name' type='text' value={editData.OrganisedBy} onChange={onChangeEditHandle} name='OrganisedBy' />
                    </div>
                    ...
                    <div className='pt-4'>
                        ...
                        <Textarea placeholder='Please provide details about the achievement' className='mt-3 bg-primary-foreground' value={editData.ProvideReason} name='ProvideReason' onChange={onChangeEditHandle} />
                    </div>


                    <div className='pt-4'>
                        <Label htmlFor="" className='font-semibold text-[17px]'>Upload Certificate</Label>
                        <Input type="file" id="GujcetUpload" hidden name='UploadCertificate' onChange={onChangeEditHandle} />
                    ...
                    <div className='py-8'>
                        <Button className='w-full cursor-pointer' onClick={onEditHandle}>Submit</Button>
                    </div>
                </form>
            </div>
        </div>
